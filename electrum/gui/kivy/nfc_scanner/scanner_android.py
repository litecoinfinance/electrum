...
class ScannerAndroid(NFCBase):
    ...
    def create_AAR(self):
        ...
        '''
        return NdefRecord.createApplicationRecord(JString("org.electrum_ltfn.kivy"))

    def create_TNF_EXTERNAL(self, data):
        '''Create our actual payload record.
        '''
        if BUILDVERSION >= 14:
            domain = "org.electrum_ltfn"
            stype = "externalType"
            ...
            extRecord = NdefRecord(
                ...
                "org.electrum_ltfn:externalType",
                '',
                data)
        return extRecord
