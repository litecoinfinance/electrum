...
class UpdateCheck(QDialog, Logger):
    url = "https://ltfn.scalaris.info/version"
    download_url = "https://ltfn.scalaris.info/wallet#electrumwallet"
    ...
    def __init__(self, *, latest_version=None):
        ...
        self.setWindowTitle('Electrum LitecoinFinance - ' + _('Update Check'))
