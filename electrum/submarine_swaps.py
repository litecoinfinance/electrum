...
API_URL_MAINNET = 'https://swaps.ltfn.scalaris.info/api'
API_URL_TESTNET = 'https://swaps.ltfn.scalaris.info/testnet'
...
class SwapManager(Logger):
    ...
    async def normal_swap(
        ...
        """send on-chain LTFN, receive on Lightning
    ...
    async def get_pairs(self) -> None:
        ...
        fees = pairs['pairs']['LTFN/LTFN']['fees']
        ...
        limits = pairs['pairs']['LTFN/LTFN']['limits']
