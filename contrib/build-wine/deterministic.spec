...
exe_standalone = EXE(
    ...
    a.binaries,
    a.datas,
    name=os.path.join('build\\pyi.win32\\electrum-ltfn', cmdline_name + ".exe"),
    debug=False,
    strip=None,
    upx=False,
...
exe_portable = EXE(
    ...
    name=os.path.join('build\\pyi.win32\\electrum-ltfn', cmdline_name + "-portable.exe"),
    debug=False,
    strip=None,
    upx=False,
    icon=home+'electrum/gui/icons/electrum.ico',
...
exe_inside_setup_noconsole = EXE(
    ...
    name=os.path.join('build\\pyi.win32\\electrum-ltfn', cmdline_name),
    debug=False,
    strip=None,
    upx=False,
    icon=home+'electrum/gui/icons/electrum.ico',
...
exe_inside_setup_console = EXE(
    ...
    a.scripts,
    exclude_binaries=True,
    name=os.path.join('build\\pyi.win32\\electrum-ltfn', cmdline_name+"-debug"),
    debug=False,
    strip=None,
    upx=False,
    icon=home+'electrum/gui/icons/electrum.ico',
...
coll = COLLECT(
    ...
    icon=home+'electrum/gui/icons/electrum.ico',
    console=False,
    name=os.path.join('dist', 'electrum-ltfn'))
