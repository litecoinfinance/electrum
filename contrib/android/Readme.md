...
$ adb shell monkey -p org.electrum_ltfn.electrum_ltfn 1
```
...
```
adb logcat | grep -F "`adb shell ps | grep org.electrum_ltfn.electrum_ltfn | cut -c14-19`"
```
...
```
$ adb shell
$ run-as org.electrum_ltfn.electrum_ltfn ls /data/data/org.electrum_ltfn.electrum_ltfn/files/data
$ run-as org.electrum_ltfn.electrum_ltfn cp /data/data/org.electrum_ltfn.electrum_ltfn/files/data/wallets/my_wallet /sdcard/some_path/my_wallet
```
