...
3. Build binary
    ...
    $ sudo docker run -it \
        ...
        --rm \
        --workdir /opt/electrum-ltfn/contrib/build-linux/appimage \
...
Execute the binary as follows: `./electrum-ltfn*.AppImage --appimage-extract`

### How to investigate diff between binaries if reproducibility fails?
```
cd dist/
./electrum-ltfn-*-x86_64.AppImage1 --appimage-extract
mv squashfs-root/ squashfs-root1/
./electrum-ltfn-*-x86_64.AppImage2 --appimage-extract
